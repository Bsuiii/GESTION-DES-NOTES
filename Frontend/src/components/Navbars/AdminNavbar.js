              ...
              <DropdownToggle className="pr-0" nav>
                <Media className="align-items-center">
                  <span className="avatar avatar-sm rounded-circle">
                    {/* Placeholder for user picture (empty for now) */}
                    <img
                      alt="..."
                      src={require("../../assets/img/theme/team-4-800x800.jpg")} // Replace with a placeholder or leave empty
                      style={{ opacity: 0 }} // Hide the image (optional)
                    />
                  </span>
